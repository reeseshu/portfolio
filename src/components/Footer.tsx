...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', url: 'https://github.com/rshu7', icon: 'github' },
    { name: 'LinkedIn', url: 'https://linkedin.com/in/rshu7', icon: 'linkedin' },
    { name: 'Twitter', url: 'https://twitter.com/rshu7', icon: 'twitter' },
    { name: 'Instagram', url: 'https://instagram.com/rshu7', icon: 'instagram' }
  ];
