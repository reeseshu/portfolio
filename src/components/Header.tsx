        ...
        <div className="flex justify-between items-center h-16">
            ...
            <div className="ml-10 flex items-baseline space-x-8 nav-fancy">
              ...
              {edit.isAuthenticated && (
                <button
                  ...
                  className="text-white bg-green-600 hover:bg-green-700 px-3 py-2 text-sm font-semibold rounded-md"
                >
                  Save All
                </button>
              )}
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="p-2 rounded-md text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400 transition-colors duration-200"
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400 transition-colors duration-200"
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
              {navItems.map((item) => (
                <a
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400 block px-3 py-2 text-base font-medium transition-colors duration-200"
                >
                  {item.name}
                </a>
              ))}
